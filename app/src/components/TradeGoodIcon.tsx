...
const TRADE_GOOD_ICON_ROWS = 5
const TRADE_GOOD_ICON_SPRITE_URL = `${import.meta.env.BASE_URL}generated/trade/trade-goods-sprite.png`
...
export function TradeGoodIcon({ goodId, label, size = 44 }: TradeGoodIconProps) {
  ...
  const backgroundPositionY = (row / (TRADE_GOOD_ICON_ROWS - 1)) * 100
  ...
  const style: CSSProperties = {
    ...
    backgroundSize: `${TRADE_GOOD_ICON_COLUMNS * 100}% ${TRADE_GOOD_ICON_ROWS * 100}%`,
