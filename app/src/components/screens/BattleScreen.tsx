...
const styles: Record<string, CSSProperties> = {
  ...
  headerCompact: { top: 8, left: '50%', right: 'auto', width: 'var(--navigatoria-battle-header-width, calc(100vw - 16px))', padding: '8px 10px', borderRadius: 12, alignItems: 'flex-start', gap: 8, transform: 'translateX(-50%) scale(var(--navigatoria-battle-ui-scale, 1))', transformOrigin: 'top center' },
  ...
  fleetPanelCompact: { top: 82, left: 8, width: 'var(--navigatoria-battle-half-panel-width, calc(50vw - 12px))', maxHeight: 'var(--navigatoria-battle-top-panel-height, 30vh)', padding: 8, borderRadius: 12, transform: 'scale(var(--navigatoria-battle-ui-scale, 1))', transformOrigin: 'top left' },
  ...
  enemyPanelCompact: { top: 82, right: 8, width: 'var(--navigatoria-battle-half-panel-width, calc(50vw - 12px))', maxHeight: 'var(--navigatoria-battle-top-panel-height, 30vh)', padding: 8, borderRadius: 12, transform: 'scale(var(--navigatoria-battle-ui-scale, 1))', transformOrigin: 'top right' },
  ...
  logPanelCompact: { left: 8, bottom: 8, width: 'var(--navigatoria-battle-log-width, calc(42vw - 12px))', maxHeight: 'var(--navigatoria-battle-log-height, 22vh)', padding: 8, borderRadius: 12, fontSize: 10, transform: 'scale(var(--navigatoria-battle-ui-scale, 1))', transformOrigin: 'bottom left' },
  ...
  commandPanelCompact: { right: 8, bottom: 8, width: 'var(--navigatoria-battle-command-width, calc(58vw - 12px))', padding: 9, borderRadius: 12, transform: 'scale(var(--navigatoria-battle-ui-scale, 1))', transformOrigin: 'bottom right' },
  ...
  actionOverlayCompact: { top: 68, width: 'var(--navigatoria-battle-action-width, min(280px, calc(100vw - 24px)))', padding: '9px 10px', borderRadius: 12, transform: 'translateX(-50%) scale(var(--navigatoria-battle-ui-scale, 1))', transformOrigin: 'top center' },
