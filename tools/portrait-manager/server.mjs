...
function createPortraitRecord(request, threadId, existing = null) {
  ...
  return {
    ...
    viewAngle: cleanText(brief.viewAngle),
    expression: cleanText(brief.expression),
    headwear: cleanText(brief.headwear),
    facialHair: cleanText(brief.facialHair),
    hairColor: cleanText(brief.hairColor),
    eyeColor: cleanText(brief.eyeColor),
